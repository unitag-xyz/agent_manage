...
from agent_manage_v2.cli import main as agent_manage_v2_main
from openclaw_remote.cli import main as openclaw_remote_main
...
class CliResponseTest(unittest.TestCase):
    def test_agent_manage_v2_success_response_uses_result_envelope(self):
        with patch("agent_manage_v2.cli.InstanceManagerV2") as manager_cls:
            ...
            with redirect_stdout(stdout):
                exit_code = agent_manage_v2_main(
    ...
    def test_agent_manage_v2_not_found_error_is_structured(self):
        with patch("agent_manage_v2.cli.InstanceManagerV2") as manager_cls:
    ...
    def test_agent_manage_v2_tg_bot_status_uses_result_envelope(self):
        with patch("agent_manage_v2.cli.InstanceManagerV2") as manager_cls:
            ...
            stdout = io.StringIO()
            with redirect_stdout(stdout):
                exit_code = agent_manage_v2_main(["tg-bot-status"])
    ...
    def test_agent_manage_v2_delete_tg_bot_dispatches_correctly(self):
        with patch("agent_manage_v2.cli.InstanceManagerV2") as manager_cls:
    ...
    def test_openclaw_remote_runtime_error_preserves_steps_and_rollback(self):
        with patch("openclaw_remote.cli.OpenClawManager") as manager_cls:
